...
class Animation extends Component {
    ...
    drawChart(data) {
        ...
        const y = d3.scaleLinear()
            .domain([0, d3.max(data, d => d.index2005)])
            .range([iheight, 0]);
        ...
        d3.select(this.refs.index2006).on("click", function () {
            rect
                .transition()
                .style("fill", "green")
        ...
        d3.select(this.refs.index2005).on("click", function () {
            rect
                .transition()
                .style("fill", "steelblue")
                .attr("y", d => y(d.index2005))
    ...
    render() {
        return (<div ref="canvas">
            <button ref="index2005">2005</button>
            <button ref="index2006">2006</button>
        </div>
        );
    }
}
